(function (global, factory) {
    ...
    function renderMath(content, options) {
        const adaptor = (0, mathjax_liteAdaptor.liteAdaptor)();
        (0, mathjax_html.RegisterHTMLHandler)(adaptor);
        const tex = new mathjax_tex.TeX({ packages: mathjax_AllPackages.AllPackages });
        const svg = new mathjax_svg.SVG({ fontCache: "none" });
        const mathDocument = mathjax.mathjax.document(content, { InputJax: tex, OutputJax: svg });
        ...
        return (0, juice_client.default)(html + stylesheet);
    }
